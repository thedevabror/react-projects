...
const AccountDetails = () => {
  ...
  <div class="lg:text-center">
    ...
    <p class="mt-2 text-3xl leading-8 font-extrabold tracking-tight text-gray-900 sm:text-4xl">Welcome, John Doe</p>
  ...
  <div class="mt-10">
    <div class="grid gap-5 lg:grid-cols-3 lg:max-w-none">
      ...
      <div class="rounded-lg border bg-card text-card-foreground shadow-sm" data-v0-t="card">
        <div class="flex flex-col space-y-1.5 p-6">
          <h3 class="whitespace-nowrap text-2xl font-semibold leading-none tracking-tight">Payment Methods</h3>
        </div>
        <div class="p-6">
  ...
  <div class="mt-10 lg:text-center">
    <h2 class="text-base text-indigo-600 font-semibold tracking-wide uppercase">Cart &amp; Order History</h2>
  </div>
  <div class="mt-10">
    <div class="grid gap-5 lg:grid-cols-2 lg:max-w-none">
      <div class="rounded-lg border bg-card text-card-foreground shadow-sm" data-v0-t="card">
        <div class="flex flex-col space-y-1.5 p-6">
          <h3 class="whitespace-nowrap text-2xl font-semibold leading-none tracking-tight">Your Cart</h3>
        </div>
        <div class="p-6">
      ...
      <div class="rounded-lg border bg-card text-card-foreground shadow-sm" data-v0-t="card">
        ...
        <div class="p-6">
          <p class="text-sm text-gray-500">You have made 5 orders in total</p>
          <button class="inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 border border-input bg-background hover:bg-accent hover:text-accent-foreground h-10 px-4 py-2 mt-4">
            View Orders
          </button>
        </div>
