  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-1 xs:grid-cols-2 md:grid-cols-3 lg:grid-cols-3 xl:grid-cols-4 2xl:grid-cols-5 gap-2 lg:gap-5  p-[15px]">
        <div
          role="status"
          class="w-[242px] h-[470.45px] border border-gray-200 rounded shadow animate-pulse md:p-6 dark:border-gray-700"
        >
        ...
        <div
          role="status"
          class="w-[242px] h-[470.45px] p-4 border border-gray-200 rounded shadow animate-pulse md:p-6 dark:border-gray-700"
        >
          <div class="flex items-center justify-center h-48 mb-4 bg-gray-300 rounded dark:bg-gray-700">
            <svg
              class="w-10 h-10 text-gray-200 dark:text-gray-600"
